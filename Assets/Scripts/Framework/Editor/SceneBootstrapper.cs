...
namespace Framework.Editor
{
    ...
    public class SceneBootstrapper
    {
        ...
        private const string OpenBootstrapMenuKey = "Tools/Open Bootstrap Scene";
        ...
        // Adds a menu item called "Open Bootstrap Scene On Play" to the GameSystems menu and
        // disables the behavior if selected.
        [MenuItem(OpenBootstrapMenuKey)]
        private static void OpenBootstrapper()
        {
            if (EditorSceneManager.SaveCurrentModifiedScenesIfUserWantsTo() && IsSceneInBuildSettings(BootstrapScene))
                EditorSceneManager.OpenScene(BootstrapScene);
        }
